...
###selection strategy bt trial

```{r}

# crate a graph in which participants within-trial order is in the x axis and the difference between their rating and the agent rating is in the y axis. (seperated by condition )
...
>>>>>>> 687252280d5727d7f8f591a4336addafc10f8cc6
